        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-9 col-lg-9">
                ...
                if (isset($_GET['submit'])) {
                    ...
                    mysqli_close($conn);
                    echo "แก้ไขข้อมูล $prj_name_th เรียบร้อยแล้ว<br>";
                    ...
                    <input type="hidden" name="prj_id" id="prj_id" value="<?php echo "$prj_id";?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="prj_name_th" id="prj_name_th" class="form-control" value="<?php echo $prj_name_th; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="prj_name_en" class="col-md-2 col-lg-2 control-label">ชื่อภาษาอังฤษ</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="prj_name_en" id="prj_name_en" class="form-control" value="<?php echo $prj_name_en; ?>">
                            </div>
                        </div>
                        <div class="form-group">
